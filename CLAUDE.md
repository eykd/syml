...
`tox.ini`, `.travis.yml`, and `.coveragerc` are stale leftovers (old Python versions, a missing requirements file). Ignore them; pyproject is the single source of tool config.
