...
description: Update the project constitution at .specify/memory/constitution.md by filling template placeholders and propagating changes to dependent artifacts.
