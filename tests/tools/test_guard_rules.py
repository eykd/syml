...
class TestBlockedRules:
    @pytest.mark.parametrize(
        ...
        [
            ...
            ('git config core.hooksPath /dev/null', 'hook-bypass'),
            ('git config --local core.hooksPath /dev/null', 'hook-bypass'),
            ('git config --global core.hooksPath /dev/null', 'hook-bypass'),
            ('git config --worktree core.hooksPath /dev/null', 'hook-bypass'),
            ('git config set core.hooksPath x', 'hook-bypass'),
            ('git config core.hookspath /dev/null', 'hook-bypass'),
